    ...
    >
      ...
      >
        <div className="glass-card p-6 rounded-xl backdrop-blur-md bg-white/5 shadow-xl border border-white/10 hover:border-white/20 transition-all duration-300">
          Hello! I&apos;m Rajat Singh, a passionate web developer and problem
          solver. Currently, I&apos;m pursuing a B.TECH degree in Computer Science and Engineering at
         ITS Engineering College in Greater Noida, India, with an expected
          ...
          making me well-versed in Full-stack- development.
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <Link
            href="mailto:rajatsingh4336@gmail.com"
            target="_blank"
            rel="noreferrer"
